...
Функция ListQueues( Знач QueueNamePrefix = Неопределено ) Экспорт
	...
	Данные.Вставить( "Action", "ListQueues" );
	Данные.Вставить( "Version", _Version );
	...
	Возврат Post( _Endpoint, Данные, ДопПараметры );
...
Функция CreateQueue( Знач QueueName, Знач QueueAttributes = Неопределено ) Экспорт
	...
	Данные.Вставить( "Action", "CreateQueue" );
	Данные.Вставить( "Version", _Version );
	
	Данные.Вставить( "QueueName", QueueName );
	Если ЗначениеЗаполнено( QueueAttributes ) Тогда
		Сч = 1;
		Для Каждого КлЗн Из QueueAttributes Цикл
			Данные.Вставить( "Attribute." + Сч + ".Name",  КлЗн.Ключ );
			Если КлЗн.Ключ = "RedrivePolicy" Тогда
				Данные.Вставить( 
					"Attribute." + Сч + ".Value",  
					СтрШаблон(
						"{""deadLetterTargetArn"":""%1"", ""maxReceiveCount"":""%2""}", 
						КлЗн.Значение.deadLetterTargetArn, 
						КакПараметр( КлЗн.Значение.maxReceiveCount )
					) 
				);
			Иначе
				Данные.Вставить( "Attribute." + Сч + ".Value", КакПараметр( КлЗн.Значение ) );
			КонецЕсли;
			Сч = Сч + 1;
		КонецЦикла;
	КонецЕсли;
...
Функция DeleteQueue( Знач QueueUrl ) Экспорт
	...
	Данные = Новый Структура;
	Данные.Вставить( "Action", "DeleteQueue" );
	Данные.Вставить( "Version", _Version );
...
Функция PurgeQueue( Знач QueueUrl ) Экспорт
	...
	Данные = Новый Структура;
	Данные.Вставить( "Action", "PurgeQueue" );
	Данные.Вставить( "Version", _Version );
	Данные.Вставить( "QueueUrl", QueueUrl );
...
Функция GetQueueUrl( Знач QueueName ) Экспорт
	...
	Данные = Новый Структура;
	Данные.Вставить( "Action", "GetQueueUrl" );
	Данные.Вставить( "Version", _Version );
	Данные.Вставить( "QueueName", QueueName );
...
Функция GetQueueAttributes( Знач QueueUrl, Знач QueueAttributeNames = Неопределено ) Экспорт
	...
	Данные = Новый Соответствие;
	Данные.Вставить( "Action", "GetQueueAttributes" );
	Данные.Вставить( "Version", _Version);
	Данные.Вставить( "QueueUrl", QueueUrl );
	
	Если ЗначениеЗаполнено( QueueAttributeNames ) Тогда
		Сч = 1;
		Для Каждого Атрибут Из QueueAttributeNames Цикл
			Данные.Вставить( "AttributeName." + Сч,  Атрибут );
			Сч = Сч + 1;
		КонецЦикла;
	КонецЕсли;
...
Функция GetQueueAttributesAll( Знач QueueUrl ) Экспорт
	
	Данные = Новый Соответствие;
	Данные.Вставить( "Action", "GetQueueAttributes" );
	Данные.Вставить( "Version", _Version );
	Данные.Вставить( "QueueUrl", QueueUrl );
	Данные.Вставить( "AttributeName.1",  "All" );
...
Функция SetQueueAttributes( Знач QueueUrl, Знач QueueAttributes = Неопределено ) Экспорт
	
	Данные = Новый Соответствие;
	Данные.Вставить( "Action", "SetQueueAttributes" );
	Данные.Вставить( "Version", _Version );
	Данные.Вставить( "QueueUrl", QueueUrl );
...
Функция SendMessage( Знач QueueUrl, Знач MessageBody, Знач DelaySeconds = Неопределено ) Экспорт
	
	Данные = Новый Структура;
	Данные.Вставить( "Action", "SendMessage" );
	Данные.Вставить( "Version", _Version );
	Данные.Вставить( "QueueUrl", QueueUrl );
	Данные.Вставить( "MessageBody", MessageBody );
	
	Если ЗначениеЗаполнено( DelaySeconds ) Тогда
		Данные.Вставить( "DelaySeconds", КакПараметр( DelaySeconds ) );
	КонецЕсли;
...
Функция RecieveMessage( Знач QueueUrl ) Экспорт
	...
	Данные = Новый Структура;
	Данные.Вставить( "Action", "ReceiveMessage" );
	Данные.Вставить( "Version", _Version );
	Данные.Вставить( "QueueUrl", QueueUrl );
...
Функция DeleteMessage( Знач QueueUrl, Знач ReceiptHandle ) Экспорт
	...
	Данные = Новый Структура;
	Данные.Вставить( "Action", "DeleteMessage" );
	Данные.Вставить( "Version", _Version );
	Данные.Вставить( "QueueUrl", QueueUrl );
...
Функция ChangeMessageVisibility( Знач QueueUrl, Знач ReceiptHandle, Знач VisibilityTimeout ) Экспорт
	...
	Данные = Новый Структура;
	Данные.Вставить( "Action", "ChangeMessageVisibility" );
	Данные.Вставить( "Version", _Version );
	Данные.Вставить( "QueueUrl", QueueUrl );
	Данные.Вставить( "ReceiptHandle", ReceiptHandle );
