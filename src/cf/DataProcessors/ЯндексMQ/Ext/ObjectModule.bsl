...
//
// Параметры:
//  ПрефиксИмениОчередей - Строка - (опц.) Префикс для фильтрации имен очередей. Чувствителен к регистру.
// 
...
//
Функция СписокОчередей( Знач ПрефиксИмениОчередей = Неопределено ) Экспорт
	
	Возврат ListQueues( ПрефиксИмениОчередей );
...
//  См. ВызватьМетод
//
Функция СписокОчередейОтвет( Знач ПрефиксИмениОчередей = Неопределено ) Экспорт

	Возврат ListQueuesResponse( ПрефиксИмениОчередей );
...
//
// Параметры:
//  UrlОчереди - Строка - URL очереди, в которой необходимо удалить все сообщения
// 
// Возвращаемое значение:
//  Булево - Признак успешности удаления всех сообщений очереди. Истина - удалено успешно, Ложь - при удалении произошла ошибка
//
Функция ОчиститьОчередь( Знач UrlОчереди ) Экспорт
	
	Возврат PurgeQueue( UrlОчереди ); 
...
//  См. ВызватьМетод
//
Функция ОчиститьОчередьОтвет( Знач UrlОчереди ) Экспорт
	
	Возврат PurgeQueueResponse( UrlОчереди ); 
...
//
// Параметры:
//  ИмяОчереди		 - Строка - Наименование очереди
//  АтрибутыОчереди	 - Структура - (опц.) Атрибуты (настройки) создаваемой очереди
// 
// Возвращаемое значение:
//  Строка - URL созданной очереди
//  Неопределено - Если очередь создать не удалось
//
Функция СоздатьОчередь( Знач ИмяОчереди, Знач АтрибутыОчереди = Неопределено ) Экспорт

	Возврат CreateQueue( ИмяОчереди, АтрибутыОчереди );
...
//  См. ВызватьМетод
//
Функция СоздатьОчередьОтвет( Знач ИмяОчереди, Знач АтрибутыОчереди = Неопределено ) Экспорт

	Возврат CreateQueueResponse( ИмяОчереди, АтрибутыОчереди );
...
//
// Параметры:
//  UrlОчереди - Строка - URL удаляемой очереди
// 
// Возвращаемое значение:
//  Булево - Признак успешности удаления очереди. Истина - удалено успешно, Ложь - при удалении произошла ошибка
//
Функция УдалитьОчередь( Знач UrlОчереди ) Экспорт
	
	Возврат DeleteQueue( UrlОчереди );
...
//  См. ВызватьМетод
//
Функция УдалитьОчередьОтвет( Знач UrlОчереди ) Экспорт
	
	Возврат DeleteQueueResponse( UrlОчереди );
	
КонецФункции



// Получает URL очереди по ее имени
//
...
//
Функция ПолучитьUrlОчереди( Знач ИмяОчереди ) Экспорт
	
	Возврат GetQueueUrl( ИмяОчереди );
...
//  См. ВызватьМетод
//
Функция ПолучитьUrlОчередиОтвет( Знач ИмяОчереди ) Экспорт
	
	Возврат GetQueueUrlResponse( ИмяОчереди );
...
//
// Параметры:
//  UrlОчереди     - Строка - URL очереди
//  ИменаАтрибутов - Массив из Строка - (опц.) Массив имен атрибутов, которые требуется получить.
//                                      Если не указан - будут получены все атрибуты
// 
// Возвращаемое значение:
//  Неопределено - в случае ошибки запроса
//  Структура - Данные атрибутов очереди
//
Функция ПолучитьАтрибутыОчереди( Знач UrlОчереди, Знач ИменаАтрибутов = Неопределено ) Экспорт

	Возврат GetQueueAttributes( UrlОчереди, ИменаАтрибутов );
...
//  См. ВызватьМетод
//
Функция ПолучитьАтрибутыОчередиОтвет( Знач UrlОчереди, Знач ИменаАтрибутов = Неопределено ) Экспорт

	Возврат GetQueueAttributesResponse( UrlОчереди, ИменаАтрибутов );
...
// Параметры:
//  UrlОчереди       - Строка    - URL очереди
//  АтрибутыОчереди  - Структура - Набор имен атрибутов и их значений
// 
// Возвращаемое значение:
//  Булево - Признак успешности установки атрибутов очереди. Истина - если успешно, Ложь - если не удалось
//
Функция УстановитьАтрибутыОчереди( Знач UrlОчереди, Знач АтрибутыОчереди ) Экспорт
	
   Возврат SetQueueAttributes( UrlОчереди, АтрибутыОчереди ); 
...
//  См. ВызватьМетод
//
Функция УстановитьАтрибутыОчередиОтвет( Знач UrlОчереди, Знач АтрибутыОчереди ) Экспорт
	
	Возврат SetQueueAttributesResponse( UrlОчереди, АтрибутыОчереди );
...
//
// Параметры:
//  UrlОчереди - Строка - URL очереди, куда требуется отправить сообщение
...
//
Функция ОтправитьСообщение( Знач UrlОчереди, Знач Сообщение ) Экспорт
	
	Возврат SendMessage( UrlОчереди, Сообщение );
...
//  См. ВызватьМетод
//
Функция ОтправитьСообщениеОтвет( Знач UrlОчереди, Знач Сообщение ) Экспорт
	
	Возврат SendMessageResponse( UrlОчереди, Сообщение );
...
//
Функция ПолучитьСообщение( Знач UrlОчереди ) Экспорт
	
	Возврат RecieveMessage( UrlОчереди );
...
//  См. ВызватьМетод
//
Функция ПолучитьСообщениеОтвет( Знач UrlОчереди ) Экспорт
	
	Возврат RecieveMessageResponse( UrlОчереди );
...
// Параметры:
//  UrlОчереди    - Строка - URL очереди
//  ReceiptHandle - Строка - Идентификатор получения сообщения. Возвращается в методе RecieveMessage 
//                           При каждом получении сообщения ему назначается новый идентификатор получения. 
//                           При удалении сообщения используйте последний идентификатор 
// 
// Возвращаемое значение:
//  Булево - Признак успешности удаления. Истина - удалено успешно, Ложь - произошла ошибка при удалении
//
Функция УдалитьСообщение( Знач UrlОчереди, Знач ReceiptHandle ) Экспорт
	
	Возврат DeleteMessage( UrlОчереди, ReceiptHandle );
...
//  См. ВызватьМетод
//
Функция УдалитьСообщениеОтвет( Знач UrlОчереди, Знач ReceiptHandle ) Экспорт
	
	Возврат DeleteMessageResponse( UrlОчереди, ReceiptHandle );	
...
// Параметры:
//  UrlОчереди    - Строка - URL очереди
//  ReceiptHandle - Строка - Идентификатор видимости сообщения. Получается из метода RecieveMessage
//  ТаймаутВидимостиСообщения - Число  - Новое значение таймаута видимости сообщения в секундах. Возможные значения: от 0 до 43200 секунд.
// 
// Возвращаемое значение:
//  Булево - Признак успешности изменения. Истина - если успешно, Ложь - если не удалось изменить
//
Функция ИзменитьВидимостьСообщения( Знач UrlОчереди, Знач ReceiptHandle, Знач ТаймаутВидимостиСообщения ) Экспорт

	Возврат ChangeMessageVisibility( UrlОчереди, ReceiptHandle, ТаймаутВидимостиСообщения );
...
//  См. ВызватьМетод
//
Функция ИзменитьВидимостьСообщенияОтвет( Знач UrlОчереди, Знач ReceiptHandle, Знач ТаймаутВидимостиСообщения ) Экспорт

	Возврат ChangeMessageVisibilityResponse( UrlОчереди, ReceiptHandle, ТаймаутВидимостиСообщения );
...
//
// Параметры:
//  QueueNamePrefix - Строка - (опц.) Префикс для фильтрации имен очередей. Чувствителен к регистру.
// 
// Возвращаемое значение:
//  Неопределено - если запрос завершился ошибкой
//  Структура:
...
//        * NextToken – Строка            - токен пагинации, используется при получении списка очередей частями
//
Функция ListQueues( Знач QueueNamePrefix = Неопределено ) Экспорт

	Ответ = ListQueuesResponse( QueueNamePrefix );
...
//
// Параметры:
//  QueueUrl - Строка - URL удаляемой очереди
// 
// Возвращаемое значение:
//  Булево - Признак успешности удаления очереди. Истина - удалено успешно, Ложь - при удалении произошла ошибка
//
Функция DeleteQueue( Знач QueueUrl ) Экспорт
...
//
// Параметры:
//  QueueUrl - Строка - URL очереди, в которой необходимо удалить все сообщения
// 
// Возвращаемое значение:
//  Булево - Признак успешности удаления всех сообщений очереди. Истина - удалено успешно, Ложь - при удалении произошла ошибка
//
Функция PurgeQueue( Знач QueueUrl ) Экспорт
	
	Ответ = PurgeQueueResponse( QueueUrl );
	Возврат 200 = Ответ.КодСостояния;
...
//
// Параметры:
//  QueueName		 - Строка    - Наименование очереди
//  QueueAttributes	 - Структура - (опц.) Атрибуты (настройки) создаваемой очереди
// 
// Возвращаемое значение:
//  Строка - URL созданной очереди
//  Неопределено - Если очередь создать не удалось
//
Функция CreateQueue( Знач QueueName, Знач QueueAttributes = Неопределено ) Экспорт
	
	Ответ = CreateQueueResponse( QueueName, QueueAttributes );
	Если 200 <> Ответ.КодСостояния Тогда
		Возврат Неопределено;
	КонецЕсли;
...
//
// Параметры:
//  QueueName - Строка - Имя очереди 
// 
// Возвращаемое значение:
//  Строка       - URL очереди в случае успешного запроса
//  Неопределено - в случае ошибки запроса (например, очереди с таким именем не существует)
//
Функция GetQueueUrl( Знач QueueName ) Экспорт
	
	Ответ = GetQueueUrlResponse( QueueName );
	Если 200 <> Ответ.КодСостояния Тогда
		Возврат Неопределено;	
	КонецЕсли;
...
//
// Параметры:
//  QueueUrl            - Строка - URL очереди
//  QueueAttributeNames - Массив из Строка - (опц.) Массив имен атрибутов, которые требуется получить.
//                                      Если не указан - будут получены все атрибуты
// 
// Возвращаемое значение:
//  Неопределено - в случае ошибки запроса
//  Структура - Данные атрибутов очереди
//
Функция GetQueueAttributes( Знач QueueUrl, Знач QueueAttributeNames = Неопределено ) Экспорт
	
	Ответ = GetQueueAttributesResponse( QueueUrl, QueueAttributeNames );
...
// Параметры:
//  QueueUrl        - Строка    - URL очереди
//  QueueAttributes - Структура - Набор имен атрибутов и их значений
// 
// Возвращаемое значение:
//  Булево - Признак успешности установки атрибутов очереди. Истина - если успешно, Ложь - если не удалось
//
Функция SetQueueAttributes( Знач QueueUrl, Знач QueueAttributes ) Экспорт
	
	Ответ = SetQueueAttributesResponse( QueueUrl, QueueAttributes );
	Возврат 200 = Ответ.КодСостояния;
...
//
// Параметры:
//  QueueUrl    - Строка - URL очереди, куда требуется отправить сообщение
//  MessageBody - Строка - Сообщение
// 
// Возвращаемое значение:
//  Структура:
//        * MD5OfMessageAttributes – Строка - MD5-хэш строки атрибута
...
//  Неопределено - если отправка сообщения завершилась ошибкой
//
Функция SendMessage( Знач QueueUrl, Знач MessageBody ) Экспорт
	
	Ответ = SendMessageResponse( QueueUrl, MessageBody );
	Если 200 <> Ответ.КодСостояния Тогда
		Возврат Неопределено;
	КонецЕсли;
...
//  Массив - Массив из Структур с данными полученных сообщений
//
Функция RecieveMessage( Знач QueueUrl ) Экспорт
	
	Ответ = RecieveMessageResponse( QueueUrl );
	Если 200 <> Ответ.КодСостояния Тогда
		Возврат Неопределено;
	КонецЕсли;
...
Функция DeleteMessage( Знач QueueUrl, Знач ReceiptHandle ) Экспорт
	...
	Ответ = DeleteMessageResponse( QueueUrl, ReceiptHandle );
	Возврат 200 = Ответ.КодСостояния;
...
//  QueueUrl          - Строка - URL очереди
//  ReceiptHandle     - Строка - Идентификатор видимости сообщения. Получается из метода RecieveMessage
//  VisibilityTimeout - Число  - Новое значение таймаута видимости сообщения в секундах. Возможные значения: от 0 до 43200 секунд.
// 
// Возвращаемое значение:
//  Булево - Признак успешности изменения. Истина - если успешно, Ложь - если не удалось изменить
//
Функция ChangeMessageVisibility( Знач QueueUrl, Знач ReceiptHandle, Знач VisibilityTimeout ) Экспорт
	
	Ответ = ChangeMessageVisibilityResponse( QueueUrl, ReceiptHandle, VisibilityTimeout );
	Возврат 200 = Ответ.КодСостояния;
...
//  См. ВызватьМетод
//
Функция ListQueuesResponse( Знач QueueNamePrefix = Неопределено ) Экспорт
	
	Данные = Новый Структура;
	Если ЗначениеЗаполнено( QueueNamePrefix ) Тогда
		Данные.Вставить( "QueueNamePrefix", QueueNamePrefix );
	КонецЕсли;
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.ListQueues" );
	...
	Возврат Post( _Endpoint, , ДопПараметры );
...
//  См. ВызватьМетод
//
Функция CreateQueueResponse( Знач QueueName, Знач QueueAttributes = Неопределено ) Экспорт
	
	Данные = Новый Соответствие;
	Данные.Вставить( "QueueName", QueueName );
	Если ЗначениеЗаполнено( QueueAttributes ) Тогда
		Данные.Вставить("Attributes", QueueAttributes);
	КонецЕсли;
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.CreateQueue" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
...
//  См. ВызватьМетод
//
Функция DeleteQueueResponse( Знач QueueUrl ) Экспорт
	
	Данные = Новый Структура;
	Данные.Вставить( "QueueUrl", QueueUrl );
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.DeleteQueue" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
...
//  См. ВызватьМетод
//
Функция PurgeQueueResponse( Знач QueueUrl ) Экспорт
	
	Данные = Новый Структура;
	Данные.Вставить( "QueueUrl", QueueUrl );
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.PurgeQueue" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
...
//  См. ВызватьМетод
//
Функция GetQueueUrlResponse( Знач QueueName ) Экспорт
	
	Данные = Новый Структура;
	Данные.Вставить( "QueueName", QueueName );
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.GetQueueUrl" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
...
//  См. ВызватьМетод
//
Функция GetQueueAttributesResponse( Знач QueueUrl, Знач QueueAttributeNames = Неопределено ) Экспорт
	
	Данные = Новый Соответствие;
	Данные.Вставить( "QueueUrl", QueueUrl );
	
	Если ЗначениеЗаполнено( QueueAttributeNames ) Тогда
		Данные.Вставить( "AttributeNames", QueueAttributeNames );
	Иначе
		СписокАтрибутов = Новый Массив;
		СписокАтрибутов.Добавить("All");
		Данные.Вставить( "AttributeNames", СписокАтрибутов );
	КонецЕсли;
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.GetQueueAttributes" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
...
//  См. ВызватьМетод
//
Функция SetQueueAttributesResponse( Знач QueueUrl, Знач QueueAttributes ) Экспорт
	
	Данные = Новый Соответствие;
	Данные.Вставить( "QueueUrl", QueueUrl );
	Атрибуты = Новый Структура;
	Для Каждого Attr Из QueueAttributes Цикл
		Атрибуты.Вставить( Attr.Ключ, КакПараметр( Attr.Значение ) );
	КонецЦикла;
	Данные.Вставить( "Attributes", Атрибуты );
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.SetQueueAttributes" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
...
//  См. ВызватьМетод
//
Функция SendMessageResponse( Знач QueueUrl, Знач MessageBody ) Экспорт
	
	Данные = Новый Структура;
	Данные.Вставить( "QueueUrl", QueueUrl );
	Данные.Вставить( "MessageBody", MessageBody );
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.SendMessage" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
...
//  См. ВызватьМетод
//
Функция RecieveMessageResponse( Знач QueueUrl ) Экспорт

	Данные = Новый Структура;
	Данные.Вставить( "QueueUrl", QueueUrl );
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.ReceiveMessage" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
...
//  См. ВызватьМетод
//
Функция DeleteMessageResponse( Знач QueueUrl, Знач ReceiptHandle ) Экспорт

	Данные = Новый Структура;
	Данные.Вставить( "QueueUrl", QueueUrl );
	Данные.Вставить( "ReceiptHandle", ReceiptHandle );
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.DeleteMessage" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
 	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
...
//  См. ВызватьМетод
//
Функция ChangeMessageVisibilityResponse( Знач QueueUrl, Знач ReceiptHandle, Знач VisibilityTimeout ) Экспорт
	
	Данные = Новый Структура;
	Данные.Вставить( "QueueUrl", QueueUrl );
	Данные.Вставить( "ReceiptHandle", ReceiptHandle );
	Данные.Вставить( "VisibilityTimeout", КакПараметр( VisibilityTimeout ) );
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить( "X-Amz-Target", "AmazonSQS.ChangeMessageVisibility" );
	Заголовки.Вставить( "Content-Type", "application/x-amz-json-1.0" );
	Если ЗначениеЗаполнено( _SecurityToken ) Тогда
		Заголовки.Вставить( "x-amz-security-token", _SecurityToken );
	КонецЕсли;
